...
<body class="back">
    ...
    <form action="/presupuestoact?folio=<?php echo $res->folio ?>" method="POST">
        <form>
            <ul class="ul">
                <li>
                    <table class="table">
                        ...
                        <tr class="tr">
                            ...
                            <?php foreach($resultado as $res):?>
                            <td class="td">
                                <input type="number"  class="inpInv" name="total" value="<?php echo $res->total?>">
                            </td>
                            <td class="td">
                                <input type="Date" class="inpInv" name="fechatotal" required value="<?php echo $res->fechatotal?>">
                            </td>
        ...
        <a class="btnh" type="submit" href="consentimiento?id=<?php echo $res->id?>"> Carta de Consentimiento </a>
